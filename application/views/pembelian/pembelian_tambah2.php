      ...
      <div class="panel-body">
        <div class="col-md-6">
          <div class="form-group">
            <label class="col-lg-4 control-label">ID. Order</label>
            <div class="col-lg-7">
              <input type="text" id="id_order" name="id_order" class="form-control" value="<?= $kodeunik; ?>" readonly>
            </div>
          </div>
        ...
        <div class="col-md-6">
          <div class="form-group">
            <label class="col-lg-4 control-label">Nama Client</label>
            <div class="col-lg-7">
              <input type="text" id="nama_client" name="nama_client" class="form-control" value="">
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-xs-12">
            ...
            <div class="box box-primary">
              ...
              <div class="box-header with-border">
                <table id="addAsset" class="table table-striped" width=100%>
                  <thead>
                    <tr>
                      <td align="center"><h5>ID Produk</h5></td>
                     
                      <td align="center"><h5>Jumlah Produk</h5></td>
                      <td align="center"><h5>Harga Produk</h5></td>
                      <td align="center"><h5>Total Harga Produk</h5></td>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
            ...
            function tambah(){
            i++;
            var add_asset = "<select name='id_produk[]' class='form-control' id='id_produk'><option>Pilih Produk</option><?php foreach($result_produk_pilihan as $row) { echo "<option value='".$row['id_produk']."'>".$row['id_produk'].'</option>'; } ?> </select>";
