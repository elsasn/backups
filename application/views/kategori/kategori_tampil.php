              ...
              <table class="table table-hover datatable"  width="100%" cellspacing="0">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="<?php echo base_url('kategori/ubah/'.$kategori->category_id) ?>"
                       class="btn btn-sm btn-primary btn-flat"><i class="fa fa-edit"></i> Edit</a>
                      <button onclick="deleteConfirm('<?php echo base_url('kategori/delete/'.$kategori->category_id) ?>')"
