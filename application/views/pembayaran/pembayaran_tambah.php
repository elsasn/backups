        ...
        <form class="form-horizontal" action="<?php echo site_url('pembayaran/tambah_proses');?>" method="post">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-7">
                        <input type="text" id="tgl_pembayaran" name="tgl_pembayaran" class="form-control tgl" value="<?php echo date('Y-m-d'); ?>" readonly>
                    </div>
                </div>

                <div class="form-group">
                   <!-- <?php
        print_r($result_pembelian_pilihan);
        ?>  -->
                    <label class="col-lg-4 control-label">ID Pembelian</label>
                    <div class="col-lg-7">
                        <select name="id_pembelian" class="form-control" onchange="isi_otomatis()" id="id_pembelian" required>
                            <option value="">Pilih Transaksi Pembelian</option>
                            <?php 
                            foreach($result_pembelian_pilihan as $row)
                            { 
