                  ...
                  <table class="table table-hover datatable"  width="100%" cellspacing="0">
                    <thead>
                      <tr>
                        ...
                        <th width="150">Tgl Pembayaran</th>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td >
                          <?php echo $pembayaran->id_pembelian ?>
                        </td>
                        <td >
                          <?php echo $pembayaran->total_pembayaran ?>
                        </td>
                        <td >
                        ...
                        <td>
                          <a href="<?php echo base_url('pembayaran/print/'.$pembayaran->id_pembayaran) ?>"
