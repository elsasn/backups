    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url('produk') ?>"><i class="fa fa-circle-o"></i> Produk</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?php echo base_url('inventarisasi') ?>"><i class="fa fa-circle-o"></i> Inventarisasi</a></li>
            <li><a href="<?php echo base_url('pengelolaan') ?>"><i class="fa fa-circle-o"></i> Pengelolaan</a></li>
             ...
             <!-- <li><a href="<?php echo base_url('maintenance') ?>"><i class="fa fa-circle-o"></i> Maintenance</a></li> -->
             <li><a href="<?php echo base_url('pembayaran') ?>"><i class="fa fa-circle-o"></i> Pembayaran</a></li> 
             <li><a href="<?php echo base_url('pembelian') ?>"><i class="fa fa-circle-o"></i> Pembelian</a></li>
          </ul>
        </li>
         <!-- p -->
