...
<body>
                ...
                <div class='row'>
                    <div class='col-md-12'>
                        <div id='main-slider' class='owl-carousel owl-theme'>
                            <div class='item'><img src="<?php echo base_url('design/web1/img/main-slider1.jpg') ?>" alt='' class='img-fluid'></div>
                            <div class='item'><img src="<?php echo base_url('design/web1/img/main-slider2.jpg') ?>" alt='' class='img-fluid'></div>
                            <div class='item'><img src="<?php echo base_url('design/web1/img/main-slider3.jpg') ?>" alt='' class='img-fluid'></div>
                            <div class='item'><img src="<?php echo base_url('design/web1/img/main-slider4.jpg') ?>" alt='' class='img-fluid'></div>
                        </div>
                        <!-- /#main-slider-->
                    </div>
                </div>
            ...
            <div id='hot'>
                ...
                <div class='container'>
                    <div class='product-slider owl-carousel owl-theme'>
                        <?php foreach($post_product->result() as $row):?>
                            <div class='item'>
                                <div class='product'>
                                    <div class='flip-container'>
                                        <div class='flipper'>
                                            <div class='front'><a href=''><img src="<?=base_url()?>assets/picture/<?=$row->image?>" alt='' class='img-fluid'></a></div>
                                            <div class='back'><a href=''><img src="<?=base_url()?>assets/picture/<?=$row->image?>" alt='' class='img-fluid'></a></div>
                                        </div>
                                    </div><a href='' class='invisible'><img src="<?=base_url()?>assets/picture/<?=$row->image?>" alt='' class='img-fluid'></a>
                                    <div class='text'>
                                        ...
                                        <p class='price'>
                                            <?php echo $row->name;?>
                                                <?php echo $row->price;?>
                                                    ...
                                                    <h3><a href='https://wa.me/6281717252825' class="button">Buy</a></h3>
                ...
                <div class='col-md-12'>
                    <div class='box slideshow'>
                        ...
                        <div id='get-inspired' class='owl-carousel owl-theme'>
                            <div class='item'><a href='#'><img src="<?php echo base_url('design/web1/img/inspirasi_1.jpg') ?>" alt='Get inspired' class='img-fluid'></a></div>
                            <div class='item'><a href='#'><img src="<?php echo base_url('design/web1/img/inspirasi_2.jpg') ?>" alt='Get inspired' class='img-fluid'></a></div>
                            <div class='item'><a href='#'><img src="<?php echo base_url('design/web1/img/inspirasi_3.jpg') ?>" alt='Get inspired' class='img-fluid'></a></div>
                            <div class='item'><a href='#'><img src="<?php echo base_url('design/web1/img/inspirasi_4.jpg') ?>" alt='Get inspired' class='img-fluid'></a></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class='container'>
            <div class='row'>
                ...
                <div class='col-lg-3 col-md-6'>
                    ...
                    <p><strong>Wedding Organizer</strong>
                        <br>Perkiosan rt. 01/09, pucang miliran
                        <br>KAB. KLATEN - TULUNG
                        <br>JAWA TENGAH
                        <br>ID 57482
                        <br>
                    </p>
    ...
    *** COPYRIGHT ***
    ...
    <script src="<?php echo base_url('design/web1/vendor/jquery.cookie/jquery.cookie.js') ?>">
    </script>
