...
CREATE TABLE `asset` (
  ...
  `status` enum('Milik Sendiir','Hibah') DEFAULT NULL,
  PRIMARY KEY (`id_asset`),
  CONSTRAINT `asset_ibfk_1` FOREIGN KEY (`id_asset`) REFERENCES `det_inventarisasi` (`id_det_inventarisasi`),
  CONSTRAINT `asset_ibfk_2` FOREIGN KEY (`id_asset`) REFERENCES `trans_penyusutan` (`id_trans_penyusutan`),
  CONSTRAINT `asset_ibfk_3` FOREIGN KEY (`id_asset`) REFERENCES `det_pengajuan` (`id_det_pengajuan`),
  CONSTRAINT `asset_ibfk_4` FOREIGN KEY (`id_asset`) REFERENCES `det_perencanaan` (`id_det_perencanaan`),
  CONSTRAINT `asset_ibfk_5` FOREIGN KEY (`id_asset`) REFERENCES `det_pengelolaan` (`id_det_pengelolaan`),
  CONSTRAINT `asset_ibfk_6` FOREIGN KEY (`id_asset`) REFERENCES `det_penghapusan` (`id_det_penghapusan`)
...
CREATE TABLE `jenis_asset` (
  ...
  CONSTRAINT `jenis_asset_ibfk_1` FOREIGN KEY (`id_jenis_asset`) REFERENCES `asset` (`id_asset`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
