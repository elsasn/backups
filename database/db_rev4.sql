...
CREATE TABLE `det_pengadaan` (
  `id_det_pengadaan` varchar(50) NOT NULL,
  `id_pengadaan` varchar(50) DEFAULT NULL,
  `nama_asset` varchar(50) DEFAULT NULL,
  `jumlah` int(11) DEFAULT NULL,
  `harga_pengadaan` double DEFAULT NULL,
  `harga_realisasi` double DEFAULT NULL,
  `subtotal_perencanaan` double DEFAULT NULL,
  `subtotal_realisasi` double DEFAULT NULL,
...
CREATE TABLE `pengadaan` (
  ...
  `tgl_pengadaaan` datetime DEFAULT NULL,
  `tgl_perencanaan` datetime DEFAULT NULL,
