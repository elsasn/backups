...
function elFinderAutoloader($name) {
	$map = array(
		...
		'elFinderPluginAutoResize' => ELFINDER_PHP_ROOT_PATH . '/core/plugins/AutoResize/plugin.php',
		'elFinderPluginAutoRotate' => ELFINDER_PHP_ROOT_PATH . '/core/plugins/AutoRotate/plugin.php',
		'elFinderPluginNormalizer' => ELFINDER_PHP_ROOT_PATH . '/core/plugins/Normalizer/plugin.php',
		'elFinderPluginSanitizer' => ELFINDER_PHP_ROOT_PATH . '/core/plugins/Sanitizer/plugin.php',
		'elFinderPluginWatermark' => ELFINDER_PHP_ROOT_PATH . '/core/plugins/Watermark/plugin.php',
	...
	if (substr($prefix, 0, 8) === 'elFinder') {
		if ($prefix === 'elFinderVolume') {
			...
			$file = ELFINDER_PHP_ROOT_PATH . '/core/plugins/' . substr($name, 14) . '/plugin.php';
			return (is_file($file) && include_once($file));
		}
	}
	return false;
