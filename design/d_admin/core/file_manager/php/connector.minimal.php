...
$opts = array(
	...
	'roots' => array(
		array(
			...
			'path'          => '../../core/assets/icons/',                 // path to files (REQUIRED)
			'URL'           => dirname($_SERVER['PHP_SELF']) . '/../../core/assets/icons/', // URL to files (REQUIRED)
		...
		array(
			'driver'        => 'LocalFileSystem',           // driver for accessing file system (REQUIRED)
			'path'          => '../../core/assets/img/gallery/',                 // path to files (REQUIRED)
			'tmbPath'       => '../files/thumbnails/',
			'tmbURL'        => dirname($_SERVER['PHP_SELF']) . '/../files/thumbnails',
			'URL'           => dirname($_SERVER['PHP_SELF']) . '/../../core/assets/img/gallery/', // URL to files (REQUIRED)
			'uploadDeny'    => array('all'),                // All Mimetypes not allowed to upload
			'uploadAllow'   => array('image', 'text/plain'),// Mimetype `image` and `text/plain` allowed to upload
			'uploadOrder'   => array('deny', 'allow'),      // allowed Mimetype `image` and `text/plain` only
			'accessControl' => 'access'                     // disable and hide dot starting files (OPTIONAL)
