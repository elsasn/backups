    ...
    function refreshPagination(wizard, options, state)
    {
        if (options.enablePagination)
        {
            var finish = wizard.find(".actions a[href$='#finish']").parent(),
                finish = wizard.find(".actions a[href$='#finish']").attr('id', 'finish_step'),
                next = wizard.find(".actions a[href$='#next']").attr('id', 'next_step');
 ...
 *     });
    ...
    var defaults = $.fn.steps.defaults = {
        ...
        labels: {
             ...
             * @for defaults
             **/
            next: "Simpan & Lanjutkan <i class='material-icons'>&#xE315;</i>",
             ...
             * @for defaults
             **/
            previous: "<i class='material-icons'>&#xE314;</i> Kembali",
