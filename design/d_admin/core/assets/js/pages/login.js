...
uk_login_page = {
    init: function () {
        ...
        $('#login_help_show').on('click',function(e) {
            ...
            uk_md.card_show_hide($login_card,undefined,login_help_show,undefined);
        });
        ...
        $('#signup_form_show').on('click',function(e) {
            ...
            uk_md.card_show_hide($login_card,undefined,register_form_show,undefined);
        });
        ...
        $('.back_to_login').on('click',function(e) {
            ...
            uk_md.card_show_hide($login_card,undefined,login_form_show,undefined);
        });

        $('#password_reset_show').on('click',function(e) {
            e.preventDefault();
            // card animation & complete callback: password_reset_show
            uk_md.card_show_hide($login_card,undefined,password_reset_show,undefined);
        });
