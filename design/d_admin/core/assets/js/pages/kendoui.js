            ...
            $kUI_autocomplete_template.kendoAutoComplete({
                ...
                '<div class="k-list-wrapper">'+
                    '<span class="k-state-default k-list-wrapper-addon">' +
                        '<img src=\"core/assets/img/avatars/avatar_#:data.CustomerID#_tn.png\" alt=\"#:data.CustomerID#\" />' +
                    '</span>' +
        ...
        if($kUI_multiselect_custom_template.length) {
            $kUI_multiselect_custom_template.kendoMultiSelect({
                ...
                itemTemplate:
                    ...
                    '</div>',
                tagTemplate:
                    '<img class="k-tag-image" src=\"core/assets/img/avatars/avatar_#:data.CustomerID#_tn.png\" alt=\"${data.CustomerID}\" />' +
                    '#: data.ContactName #',
                dataSource: {
                    transport: {
                        read: {
