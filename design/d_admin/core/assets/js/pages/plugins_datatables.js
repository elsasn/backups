$(function() {
    // datatables
    uk_datatables.dt_default();
    uk_datatables.dt_scroll();
    uk_datatables.dt_table_item();
    uk_datatables.dt_table_item_custom();
    uk_datatables.dt_individual_search();
    uk_datatables.dt_colVis();
    uk_datatables.dt_tableExport();
});
...
uk_datatables = {
    ...
    dt_table_item: function() {
        var $dt_table_item = $('#dt_table_item');
        if($dt_table_item.length) {
            $dt_table_item.DataTable({
                "scrollY": "345px",
                "scrollCollapse": false,
                "paging": false,
                "lengthChange": false,
    ...
    dt_table_item_custom: function() {
        var $dt_table_item_custom = $('#dt_table_item_custom');
        if($dt_table_item_custom.length) {
            $dt_table_item_custom.DataTable({
                "scrollY": "345px",
                "scrollCollapse": false,
                "paging": false,
                "lengthChange": false,
