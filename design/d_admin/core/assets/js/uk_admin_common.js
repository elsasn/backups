...
// 1. Init common functions on document ready
    ...
    $(function() {
        ...
        // main sidebar
        uk_main_sidebar.init();
        // secondary sidebar
        uk_secondary_sidebar.init();

        // top bar
        uk_top_bar.init();

        // page heading
        uk_page_heading.init();
        ...
        uk_helpers.truncate_text($('.truncate-text'));

        // full screen
        uk_helpers.full_screen();

        // table check
        uk_helpers.table_check();

        // print page
        uk_helpers.print_page();
...
// 3. Common functions & variables
    ...
    uk_page_onload = {
        init: function() {
            $window.on('load',function(){
                ...
                uk_helpers.hierarchical_show();
                uk_helpers.hierarchical_slide();
            });
        }
    };
    ...
    uk_forms = {
        init: function() {
            ...
            uk_forms.select_elements();
            uk_forms.switches();
            uk_forms.dynamic_fields();
        },
        ...
        dynamic_fields: function() {
            ...
            $('.btnSectionClone').on('click', function(e) {
                    ...
                    cloned_section
                        ...
                        .find('[data-md-selectize]').each(function(index) {
                            ...
                            if(selectize) {
                                ...
                                uk_forms.select_elements(orgSelect.parent());
                ...
                uk_md.checkbox_radio($newSection.find('[data-md-icheck]'));
                // reinitialize switches
                uk_forms.switches($newSection);
                // reinitialize selectize
                uk_forms.select_elements($newSection);
        ...
        init: function() {
            if($sidebar_main.length) {
                ...
                if(lsTest()) {
                    ...
                    if(localStorage.getItem("uk_sidebar_mini") !== null) {
                        $body.addClass('sidebar_mini');
                    }
                    if(localStorage.getItem("uk_sidebar_slim") !== null) {
                ...
                if ($body.hasClass('sidebar_mini')) {
                    ...
                    // slim sidebar
                    uk_main_sidebar.slim_sidebar();

                    // custom scroller
                    uk_helpers.custom_scrollbar($sidebar_main);

                    // menu
                    uk_main_sidebar.sidebar_menu();
                    ...
                    $sidebar_main_toggle.on('click', function(e) {
                        e.preventDefault();
                        ( $body.hasClass('sidebar_main_active') || ($body.hasClass('sidebar_main_open') && $window.width() >= 1220) ) ? uk_main_sidebar.hide_sidebar() : uk_main_sidebar.show_sidebar();
                    });
                    ...
                    if( $body.hasClass('sidebar_main_active') && $window.width() < 1220 ) {
                        uk_page_content.hide_content_sidebar();
                    } else {
                        uk_page_content.show_content_sidebar();
                    }
                    ...
                    uk_main_sidebar.swipe_open();

                }

                // language switcher
                uk_main_sidebar.lang_switcher();
            }
        },
        ...
        init: function() {
            if($sidebar_secondary.length) {
                ...
                $sidebar_secondary_toggle.on('click', function (e) {
                    e.preventDefault();
                    $body.hasClass('sidebar_secondary_active') ? uk_secondary_sidebar.hide_sidebar() : uk_secondary_sidebar.show_sidebar();
                });
                ...
                $document.on('click keydown', function(e) {
                    ...
                    if( $body.hasClass('sidebar_secondary_active') && ( ( !$(e.target).closest($sidebar_secondary).length && !$(e.target).closest($sidebar_secondary_toggle).length ) || (e.which == 27) )) {
                        uk_secondary_sidebar.hide_sidebar();
                    }
                });
                ...
                // custom scroller
                uk_helpers.custom_scrollbar($sidebar_secondary);

                // chat section
                uk_secondary_sidebar.chat_sidebar();
    ...
    uk_main_header = {
        init: function() {
            uk_main_header.search_activate();
            uk_main_header.search_autocomplete();
        },
        search_activate: function() {

            $('#main_search_btn').on('click',function(e) {
                e.preventDefault();
                uk_main_header.search_show();
            });
    ...
    uk_md = {
        init: function() {
            uk_md.inputs();
            uk_md.checkbox_radio();
            uk_md.card_fullscreen();
            uk_md.card_expand();
            uk_md.card_overlay();
            uk_md.card_single();
            uk_md.card_panel();
        ...
        card_panel: function() {
            ...
            $('.md-card-close').on('click',function(e) {
                ...
                uk_md.card_show_hide(thisCard,undefined,removeCard)
            });
        ...
        list_outside: function() {
            ...
            if($md_list_outside_wrapper && $body.hasClass('header_double_height')) {
                ...
                uk_helpers.custom_scrollbar($md_list_outside_wrapper);
            }
        },
        ...
        content_preloader_show: function(style,variant,container,width,height) {
            ...
            if(!$body.find('.content-preloader').length) {
                ...
                var preloader_content = (style == 'regular')
                    ? '<img src="core/assets/img/spinners/spinner' + image_density + '.gif" alt="" width="32" height="32">'
        ...
        color_picker: function(object,pallete,callback) {
            if(object) {
                var cp_id = randID_generator(),
                    ...
                    cp_wrapper = $('<div class="cp_uk" id="'+cp_id+'"/>');
                ...
                $body.on('click', '#'+cp_id+' span',function() {
                    $(this)
                        ...
                        .end()
                        .closest('.cp_uk').find('input').val($(this).attr('data-color'));
